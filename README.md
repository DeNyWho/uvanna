...
**Uvanna store** is a plumbing store📦 where people can buy what they need. Commercial project made with ❤️.

**```The current status of the Uvanna store is inactive```**
...
- [MoySklad](https://www.moysklad.ru/) - the first cloud-based service for trade and warehouse management in Russia, accessible from any computer at any time.
- [TinkoffPay](https://www.tinkoff.ru/kassa/develop/) - Internet acquiring service "Tinkoff Kassa."
